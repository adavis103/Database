...
// Tests 1st Relation constructor and getRelation
            if(relation1.getRelation() != "Dogs") {
                System.out.println("Failed: RelationTest() getRelation");
                return 1;
            }
...
// Tests Relation set and getTuples
            if(relation1.getTuples().size() == 0) {
                System.out.println("Failed: RelationTest() Row Insertion");
                return 1;
            }
...
// Tests Relation deletion and getTupleCount
            if(relation1.getTupleCount() != 0) {
        ...
        private int AttributeTest() {
            ...
            Attribute attribute2 = new Attribute(new Domain<String>(String.class, "Name"), "Patrice");

// Tests Attributes setValue, getValue, and Attribute constructor
            if (attribute1.getValue() != "John") {
                System.out.println("Failed: AttributeTest()");
                return 1;
            }

// Tests Attributes equal and Domains Equal
...
// Tests Tuples equal and refactor
        if (tuple2.equal(tuple1)) {
            System.out.println("Failed: TupleTest() Equal/Refactor");
            return 1;
        }

// Tests Tuples getValue, refactor, and Attribute get
        if(tuple2.get("Name").getValue() == "Ben") {
            System.out.println("Failed: TupleTest() getValue/Refactor");
            return 1;
        }
    ...
    private int RenameTest() throws Exception {
        // Create Table
        Database db = new Database();
